...
fn main() {
    ...
    let ship_dimensions = ShipDimensions::new(125.0, 21, 0.6);
    ...
    let visualization = Visualisation::new(spatium_functions, "Deadweight intnesity".to_string(), "Deadweight intnesity".to_string(), 5.95);
