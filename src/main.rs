...
fn main() {
    ...
    let deadweight_intnesity = DeadweightIntensity::new();
    let deadweight_intnesity_spatium_functions = deadweight_intnesity.spatium_functions(shiploads, &ship_dimensions);
    ...
    let lightweight_intensity = LightweightIntensity::new();
    let lightweight_intensity_spatium_functions = lightweight_intensity.spatium_functions(1750.56, &ship_dimensions);
