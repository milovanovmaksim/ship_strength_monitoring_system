...
impl BonjeanScale {
    ...
    ///
    /// Возвращает погруженную площадь шпангоута для заданной осадки [м^2] и абсциссе.
    /// Если шпангоут с координатой x отсутствует, линейно инерполируем
    /// площадь шпангоута, имея в распоряжение площадь двух соседних для заданной осадки.
    /// Parameters:
